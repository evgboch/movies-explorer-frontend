    ...
    <main className="register">
      <form className="register__form" onSubmit={ handleSubmit }>
        ...
        <label className="register__form-label " htmlFor="register-password">
          Пароль
          <input className="register__form-input register__form-input_error" id="register-password" type="password" autoComplete="off" required={ true }></input>
          <span className="register__form-error register__form-error_visible">Что-то пошло не так...</span>
        </label>
